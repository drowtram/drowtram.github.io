...
```
# Site settings
title: Alee Notebook                    # 你的博客网站标题
SEOTitle: Alee的笔记本 | Alee Notebook   # SEO 标题
...
ga_domain: aleej.com			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
我的博客标题是 **“Alee Notebook”** 但是我想要在搜索的时候显示 **“Alee的笔记本 | Alee Notebook”** ，这个就需要 SEO Title 来定义了。
